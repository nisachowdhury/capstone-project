...
AUTHOR: Modified from Microsoft’s module on learning web development
...
function imageZoom(imgID, resultID) {
    ...
    lens.addEventListener("click", found);

    function found(e){
        console.log("click");
        var pos, x, y;
        e.preventDefault();
        pos = getCursorPos(e);x = pos.x - (lens.offsetWidth / 2);
        y = pos.y - (lens.offsetHeight / 2);
        console.log(x,y);
        document.getElementsByName('output')[0].value= "Keep Trying!";
        if (x>=172 && x<=208 && y>=255 && y<=288 ){
            console.log("found!");
